...
% Last Modified by GUIDE v2.5 24-May-2022 19:43:29
...
function btn_FK_Callback(hObject, eventdata, handles)
...
ur = SerialLink(l);
ur.name = ("UR5");
ur.plot([q1 q2 q3 q4 q5 q6]*2*pi)
T = ur.fkine([q1 q2 q3 q4 q5 q6]*2*pi);

set(handles.x,'String',num2str(T.t(1)));
set(handles.y,'String',num2str(T.t(2)));
set(handles.z,'String',num2str(T.t(3)));
